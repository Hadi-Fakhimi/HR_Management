...
namespace HR_Management.API.Controllers
{
    ...
    public class LeaveRequestsController : ControllerBase
    {
        ...
        public async Task<ActionResult> ChangeApproval(int id,[FromBody] ChangeLeaveRequestApprovalDto changeLaveRequestApproval )
        {
            var command = new UpdateLeaveRequestCommand() { Id = id,ChangeLeaveRequestApprovalDto = changeLaveRequestApproval};
            await _mediator.Send(command);
            return NoContent();
        }
    }
